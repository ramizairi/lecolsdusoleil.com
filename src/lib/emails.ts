...
export const buildRendezvousEmail = ({
  ...
  const text = [
    ...
    "Votre compte client a été créé automatiquement.",
    "",
    ...
    <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 12px 30px rgba(0,0,0,0.08);">
      ...
      <div style="padding:28px; color:#2d241b;">
        ...
        <p style="font-size:15px; line-height:1.6; margin:0 0 16px;">
          Merci pour votre demande de rendez-vous chez Clos du Soleil. Votre compte client vient d'être créé automatiquement.
        </p>
        ...
        <p style="font-size:12px; color:#6b5e51; margin:18px 0 0;">
          Pour votre sécurité, nous vous invitons à modifier ce mot de passe dès votre première connexion.
        </p>
      </div>
      <div style="padding:16px 28px 22px; font-size:12px; color:#8b7b6d; border-top:1px solid #f0e7dd;">
        ...
        <p style="margin:4px 0 0;">L'équipe Clos du Soleil</p>
      </div>
    </div>
  </div>
  `;
...
export const buildPasswordResetEmail = ({
  ...
  const text = [
    ...
    loginUrl,
    "",
    "Pour votre sécurité, changez ce mot de passe dès votre prochaine connexion.",
    "",
    "L'équipe Clos du Soleil",
  ].join("\n");
  ...
  <div style="font-family: 'Helvetica Neue', Arial, sans-serif; background:#f7f4ef; padding:32px;">
    <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 12px 30px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(90deg,#f59e0b,#f97316,#fb7185); padding:22px 28px; color:#ffffff;">
        <h1 style="margin:0; font-size:22px; letter-spacing:0.4px;">Clos du Soleil</h1>
        <p style="margin:6px 0 0; font-size:14px; opacity:0.9;">Réinitialisation de mot de passe</p>
      </div>
      <div style="padding:28px; color:#2d241b;">
        <p style="font-size:16px; margin:0 0 12px;">Bonjour ${name},</p>
        <p style="font-size:15px; line-height:1.6; margin:0 0 16px;">
        ...
        <a href="${loginUrl}" style="display:inline-block; padding:12px 20px; background:#f97316; color:#ffffff; text-decoration:none; border-radius:999px; font-weight:600; font-size:14px;">Se connecter</a>
        <p style="font-size:12px; color:#6b5e51; margin:18px 0 0;">
          Pour votre sécurité, pensez à modifier ce mot de passe dès votre prochaine connexion.
        </p>
      </div>
      <div style="padding:16px 28px 22px; font-size:12px; color:#8b7b6d; border-top:1px solid #f0e7dd;">
        <p style="margin:0;">L'équipe Clos du Soleil</p>
      </div>
    </div>
  </div>
  `;
...
export const buildContactReservationNotificationEmail = ({
  ...
  const subject = "Nouvelle réservation depuis /contact";
  ...
  <div style="font-family: 'Helvetica Neue', Arial, sans-serif; background:#f7f4ef; padding:32px;">
    <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 12px 30px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(90deg,#f59e0b,#f97316,#fb7185); padding:18px 24px; color:#ffffff;">
        ...
        <p style="margin:6px 0 0; font-size:13px; opacity:0.9;">Nouvelle réservation</p>
      </div>
      <div style="padding:24px; color:#2d241b;">
        <p style="margin:0 0 12px;">Une nouvelle demande de réservation a été envoyée depuis le formulaire contact.</p>
        <div style="background:#fff7ed; border:1px solid #f7d7b8; border-radius:12px; padding:16px;">
          ...
          <p style="margin:0;">Téléphone : <strong>${safePhone}</strong></p>
        </div>
        ${
          safeMessage
  ...
  <div style="font-family: 'Helvetica Neue', Arial, sans-serif; background:#f7f4ef; padding:32px;">
    <div style="max-width:520px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 12px 30px rgba(0,0,0,0.08);">
      ...
      <div style="padding:24px; color:#2d241b;">
        ...
        <p style="margin:0 0 14px;">Voici votre code de vérification :</p>
...
export const buildAppointmentStatusEmail = ({
  ...
  const subject = "Mise à jour de votre dossier";
  ...
  if (typeof price === "number") {
    lines.push(`Montant à régler : ${price} EUR`);
  }
  ...
  lines.push("", `Accès à votre espace : ${loginUrl}`, "", "Cordialement,", "Clos du Soleil");
  ...
  if (typeof price === "number") {
    detailRows.push(`<p style="margin:0 0 8px;">Montant à régler : <strong>${price} EUR</strong></p>`);
  }
  ...
  <div style="font-family: 'Helvetica Neue', Arial, sans-serif; background:#f7f4ef; padding:32px;">
    <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 12px 30px rgba(0,0,0,0.08);">
      <div style="background:linear-gradient(90deg,#f59e0b,#f97316,#fb7185); padding:18px 24px; color:#ffffff;">
        <h1 style="margin:0; font-size:20px;">Clos du Soleil</h1>
        <p style="margin:6px 0 0; font-size:13px; opacity:0.9;">Mise à jour de votre dossier</p>
      </div>
      <div style="padding:24px; color:#2d241b;">
        <p style="font-size:15px; margin:0 0 10px;">Bonjour ${name},</p>
        <p style="margin:0 0 16px;">Une mise à jour a été effectuée sur votre dossier.</p>
        <div style="background:#fff7ed; border:1px solid #f7d7b8; border-radius:12px; padding:16px;">
          ${detailRows.join("")}
        </div>
        <a href="${loginUrl}" style="display:inline-block; margin-top:16px; padding:12px 20px; background:#f97316; color:#ffffff; text-decoration:none; border-radius:999px; font-weight:600; font-size:14px;">Accéder à mon espace</a>
      </div>
