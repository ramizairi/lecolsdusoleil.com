        ...
        <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 md:px-12 py-8">
          <div className="max-w-6xl w-full">
            ...
            <div className="max-w-3xl space-y-8">
              ...
              >
                Accompagnement bienveillant et soins personnalisés pour nous
                aînés.
              </p>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-5">
            {[
              ...
              >
                ...
                <p className="mt-2 text-xs sm:text-sm md:text-base font-semibold text-foreground/85 leading-tight">
                  {stat.label}
                </p>
              </div>
            ))}
          ...
          <div className="max-w-6xl mx-auto px-6 md:px-12 py-4 flex items-center justify-between text-sm text-muted-foreground">
            ...
            <p>
              ...
              <a
                ...
                className="hover:text-amber-700 transition-colors text-amber-600"
              >
                Ridy
              </a>
            </p>
